...
The goal of our project was to predict the match outcome (home win, tie, home loss) of the home team in 2015 soccer season using data from the seasons 20010-2014. We split this up into three tasks:
...
- Train data: 2010-2014 seasons
- Test data: 2015 season
- Gathered data from 3 different datasets:
  - Match Data
  - Team Data
  - Team Attributes Data
- Indexed by Team API ID
