...
```{r}
#fit GAM
gammod <- lm(price ~ . + bs(accommodates, df = 4) + bs(review_scores_rating, df = 3) + bs(bathrooms, df = 3) + bs(bedrooms, df = 4), data = training)
summary(gammod)
...
MSEnumbers = c(linearReg_kfold_MSE, PCR_mse, csv2, gam_MSE, tree_MSE, bagMSE, rf_MSE, boosted_MSE)
